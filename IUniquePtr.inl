...
-------------------------------------------------------------------------------*/
template<class Elem>
IUniquePtr<Elem>::IUniquePtr(Elem* pElem)
:m_pElem(pElem)
{
}
...
-------------------------------------------------------------------------------*/
template<class Elem>
IUniquePtr<Elem>::IUniquePtr(IUniquePtr& rIUniquePtr)
{
	m_pElem = rIUniquePtr.release();
}
...
-------------------------------------------------------------------------------*/
template<class Elem>
void IUniquePtr<Elem>::operator=(IUniquePtr& rhs)
{
	if(&rhs == this)
	{
		return;
...
template<class Elem>
void IUniquePtr<Elem>::operator=(Elem* rhs)
{
	this->reset(rhs);
}
...
Description:
	...
	specified, the internal pointer is initialized to that value (otherwise 
	it is set to null).
...
-------------------------------------------------------------------------------*/
template<class Elem>
void IUniquePtr<Elem>::reset(Elem* rhs)
{
	if(m_pElem)
	{
		//this is the object's "Release()", not this unique_ptr's release()
		m_pElem->release();
	}
	m_pElem = rhs;
}
